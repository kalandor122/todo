...
import { tasksApi, analyticsApi, categoriesApi, type Task, type Category, type Stats } from '../services/api';
...
export default function Dashboard() {
  ...
  const fetchData = async () => {
    try {
      const [tasksRes, rolledRes, statsRes, catsRes] = await Promise.all([
